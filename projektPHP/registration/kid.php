...
<div class="row1">
   ...
   <div class="list-group">
           ...
           $query="SELECT DISTINCT(Marka) FROM `produkt` WHERE `Id_kategorii`='3'";
   ...
   <?php
        ...
        $result=mysqli_query($db,"SELECT COUNT(*) FROM produkt WHERE `Id_kategorii`='3' ORDER BY Id_produktu");
        ...
        if(isset($_GET['brands']))
        {
            ...
            foreach($branchecked as $rowbrand)
            {
                 ...
                 $res_data = mysqli_query($db,"SELECT * FROM produkt WHERE Marka='$rowbrand' AND `Id_kategorii`='3' LIMIT $offset,$num");
        ...
        {
            $sql = "SELECT * FROM produkt WHERE `Id_kategorii`='3' LIMIT $offset,$num_products_on_each_page";
